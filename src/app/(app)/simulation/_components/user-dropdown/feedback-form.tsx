...
export default function FeedbackForm({ closeDropdownMenu }: { closeDropdownMenu: () => void }) {
    ...
    const mutation = api.user.submitFeedback.useMutation({
        onSuccess: () => {
            ...
            closeDropdownMenu(); // close feedback menu
        },
    });
            ...
            <div className="w-full p-5">
                ...
                <div className="my-3 flex justify-end">
                    <button
                        className={cn(
                            ...
                            ratingValue === "Extremely unsatisfied" ? "grayscale-0" : "opacity-50"
                        )}
                    ...
                    <button
                        className={cn(
                            "m-1 items-center justify-center p-1.5 grayscale hover:opacity-100 hover:grayscale-0",
                            ratingValue === "Unsatisfied" ? "grayscale-0" : "opacity-50"
                        )}
                    ...
                    <button
                        className={cn(
                            "m-1 items-center justify-center p-1.5 grayscale hover:opacity-100 hover:grayscale-0",
                            ratingValue === "Satisfied" ? "grayscale-0" : "opacity-50"
                        )}
                    ...
                    <button
                        className={cn(
                            "m-1 items-center justify-center p-1.5 grayscale hover:opacity-100 hover:grayscale-0",
                            ratingValue === "Extremely satisfied" ? "grayscale-0" : "opacity-50"
                        )}
                ...
                <div className="my-2 flex justify-end">
                    <Button
                        ...
                        onClick={() => {
                            if (ratingValue) {
                                mutation.mutate({ ratingValue, commentValue });
                            }
                        }}
                    >
                        Submit
